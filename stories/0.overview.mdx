...
if the above is successful, you should be on your way to creating your own dashboard!

Or, if you want to install manually, or if the create script wasn't successful please follow the [steps here](/docs/introduction-getting-started--docs)
