...
Then simply wrap your root component (usally App.tsx) with the [HassConnect](/story/components-hassconnect--default) component, don't forget to include the "ThemeProvider" to get the default theme.
