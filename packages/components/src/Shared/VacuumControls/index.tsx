      ...
      return (
        <Row gap="0.5rem">
          <FabCard
            ...
            size={35}
            icon="mdi:pause"
            onClick={() => entity.api.pause()}
          />
          <FabCard
            title="stop"
            size={35}
            icon="mdi:stop"
            onClick={() => entity.api.stop()}
          />
          <FabCard
            title="return to base"
            size={35}
            icon="mdi:home-map-marker"
            onClick={() => entity.api.returnToBase()}
          />
        </Row>
      );
    }
      ...
      return (
        <Row gap="0.5rem">
          <FabCard
            ...
            size={35}
            icon="mdi:play"
            onClick={() => entity.api.start()}
          />
          <FabCard
            title="locate"
            size={35}
            icon="mdi:map-marker"
            onClick={() => entity.api.locate()}
          />
...
export function VacuumControls({
  ...
  const { fan_speed, fan_speed_list, battery_level } = entity.attributes || {};
    ...
    <Column fullHeight fullWidth wrap="nowrap" {...rest}>
      ...
      <VacuumSize>
        <Column gap="0.5rem">
          ...
          <Icon fontSize={40} icon={icons[entity.state]} />
