...
export const DEFAULT_STATES: AlarmPanelCardConfigState[] = [
  "arm_home",
  "arm_away",
]

export const ALARM_MODE_STATE_MAP: Record<
  AlarmPanelCardConfigState | 'disarm' | 'triggered' | 'pending' | 'arming',
  AlarmMode
> = {
  arm_home: "armed_home",
  arm_away: "armed_away",
...
export const _getActionLabel = (state: AlarmPanelCardConfigState | 'disarm', labelMap?: Record<AlarmPanelCardConfigState | 'disarm', string>): string => {
