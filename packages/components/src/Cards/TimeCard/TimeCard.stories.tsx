  ...
  return (
    <HassConnect hassUrl="http://homeassistant.local:8123">
      ...
      <Alert type="warning" style={{
        ...
        <p>
          Time or Date sensor is not needed to use this card, by default it will use the local clock values from the machine running the instance.
        </p>
        <p>If you want to use sensors from home assistant you can follow the guide below, the difference being there's no need to perform formatting or updates as updates are emitted from home assistant instead of tracking the time differences with react.</p>
        <p>
