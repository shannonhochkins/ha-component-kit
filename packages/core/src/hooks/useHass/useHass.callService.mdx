...
> Note: We recommend you use the [useEntity()](/docs/hooks-useentity--docs) hook or the [useService()](/docs/hooks-useservice--docs) hook as these are more user friendly and don't require you to type out all generic inputs for typescript.
