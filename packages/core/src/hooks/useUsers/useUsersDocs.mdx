...
import { DummyComponent, DummyComponentAuthUser } from './examples/DummyComponent';
...
Options:
- `includeSystemGenerated` (default false): include system/service accounts.
- `includeInactiveUsers` (default false): include disabled users.
